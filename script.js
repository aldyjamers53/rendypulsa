...
// DOM ELEMENTS (DISESUAIKAN DENGAN ID DI INDEX.HTML KAKAK)
...
// FIX PERTAMA: ID disesuaikan menjadi "service" & "select-nominal"
...
// FIX KEDUA: ID Form disesuaikan menjadi "order-form"
const ppobForm = document.getElementById("order-form"); 
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const menit = glycolysis = sekarang.getMinutes();
