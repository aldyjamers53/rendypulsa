...
const PPOB_DATA = [
    ...
    { id: "ff655", category: "Top Up Game", name: "Free Fire 645 Diamonds", price: 86000 },    // Modal Rp81.788 -> Jual Rp86.000
...
// DOM ELEMENTS (DENGAN DETEKSI MULTI-ID ALTERNATIF)
const targetInputGroup = document.getElementById("target-input-group") || document.getElementById("grup-input-tujuan");
const targetLabel = document.getElementById("target-label") || document.getElementById("label-tujuan");
const targetNumberInput = document.getElementById("target-number") || document.getElementById("nomor-tujuan");
const productGrid = document.getElementById("product-grid") || document.getElementById("grid-produk");
const searchInput = document.getElementById("search-input") || document.getElementById("input-cari");

// Deteksi ID Menu Layanan Utama
const selectService = document.getElementById("service") || document.getElementById("pilih-layanan") || document.getElementById("layanan"); 
// Deteksi ID Menu Nominal Paket
const selectNominal = document.getElementById("select-nominal") || document.getElementById("pilih-nominal") || document.getElementById("nominal"); 

const bankInputGroup = document.getElementById("bank-input-group") || document.getElementById("grup-input-bank");
const bankNameInput = document.getElementById("bank-name") || document.getElementById("nama-bank");
const bankAccountInput = document.getElementById("bank-account") || document.getElementById("rekening-bank");
const bankOwnerInput = document.getElementById("bank-owner") || document.getElementById("pemilik-bank");

const priceTag = document.getElementById("price-tag") || document.getElementById("harga-produk");
const totalTag = document.getElementById("total-tag") || document.getElementById("total-pembayaran");
const ppobForm = document.getElementById("order-form") || document.getElementById("form-pemesanan") || document.querySelector("form"); 

const confirmationModal = document.getElementById("confirmation-modal") || document.getElementById("modal-konfirmasi");
const btnCloseModal = document.getElementById("btn-close-modal") || document.getElementById("tombol-tutup-modal");
const btnConfirmWa = document.getElementById("btn-confirm-wa") || document.getElementById("tombol-konfirmasi-wa");
const scrollToTopBtn = document.getElementById("scroll-to-top") || document.getElementById("kembali-ke-atas");
...
function initFormOptions() {
    ...
    // Reset konten default dropdown biar rapi
...
if (selectService) {
    selectService.addEventListener("change", (e) => {
        ...
        if (selectNominal) selectNominal.innerHTML = `<option value="">-- Pilih Nominal / Paket --</option>`;
...
// HANDLING EVENT LISTENER NOMINAL & PANDUAN GAME
if (selectNominal) {
...
window.directOrder = function(productId) {
    ...
    const orderSection = document.getElementById("order-section") || document.getElementById("form-pemesanan") || document.querySelector(".order-form-container");
    if (orderSection) {
...
if (ppobForm) {
    ppobForm.addEventListener("submit", (e) => {
        ...
        const namaLengkapEl = document.getElementById("user-name") || document.getElementById("nama-lengkap") || document.querySelector("input[placeholder*='nama']");
        const waEl = document.getElementById("user-phone") || document.getElementById("nomor-whatsapp") || document.querySelector("input[placeholder*='0815']");
        
        selectedProductForWA = {
            userName: namaLengkapEl ? namaLengkapEl.value : "",
            userPhone: waEl ? waEl.value : "",
        ...
        if (confirmationModal) {
            ...
            // Jika tidak menggunakan sistem modal konfirmasi, langsung kirim WA otomatis
            kirimKeWhatsApp();
        }
    });
}

// REUSABLE FUNCTION KIRIM WA
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (totalMenitSekarang < menitBuka || totalMenitSekarang > menitTutup) {
        if (ppobForm) {
            const submitBtn = ppobForm.querySelector("button[type='submit']") || ppobForm.querySelector(".btn-submit") || document.getElementById("pesan-sekarang");
            if (submitBtn) {
